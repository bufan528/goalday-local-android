...
enum class ScheduleWidgetStyle(
    ...
    SOFT(
        ...
        label = "柔和手账",
        title = "Goalday 今日",
        dotResourceName = "ic_widget_dot_f1a5b6",
    ...
    CLEAN(
        ...
        label = "清爽白底",
        title = "今日日程",
        dotResourceName = "ic_widget_dot_9eaadb",
    ...
    CONTRAST(
        ...
        label = "高对比",
        title = "GOALDAY",
        dotResourceName = "ic_widget_dot_ffffff",
    ...
    NOTEBOOK(
        ...
        label = "纸页手账",
        title = "手账日程",
        dotResourceName = "ic_widget_dot_f8d58a",
    ...
    APK_INK(
        ...
        label = "墨黑圆点",
        title = "今日日程",
        dotResourceName = "ic_widget_dot_000000",
        backgroundColor = Color.rgb(255, 255, 255),
        titleColor = Color.rgb(18, 18, 18),
        subtitleColor = Color.rgb(92, 92, 92),
        accentColor = Color.rgb(0, 0, 0),
        doneColor = Color.rgb(94, 94, 94),
        doneTextColor = Color.rgb(112, 112, 112),
    ),
    APK_FOREST(
        raw = "apk_dot_334f46",
        label = "深绿圆点",
        title = "今日计划",
        dotResourceName = "ic_widget_dot_334f46",
        backgroundColor = Color.rgb(247, 250, 246),
        titleColor = Color.rgb(42, 61, 54),
        subtitleColor = Color.rgb(94, 119, 109),
        accentColor = Color.rgb(51, 79, 70),
        doneColor = Color.rgb(103, 143, 111),
        doneTextColor = Color.rgb(104, 123, 115),
    ),
    APK_BLUE(
        raw = "apk_dot_9eaadb",
        label = "蓝紫圆点",
        title = "Goalday",
        dotResourceName = "ic_widget_dot_9eaadb",
        backgroundColor = Color.rgb(248, 249, 255),
        titleColor = Color.rgb(54, 58, 82),
        subtitleColor = Color.rgb(111, 116, 145),
        accentColor = Color.rgb(158, 170, 219),
        doneColor = Color.rgb(117, 142, 171),
        doneTextColor = Color.rgb(117, 121, 140),
    ),
    APK_SAGE(
        raw = "apk_dot_bbd1ad",
        label = "鼠尾草圆点",
        title = "今日清单",
        dotResourceName = "ic_widget_dot_bbd1ad",
        backgroundColor = Color.rgb(250, 252, 247),
        titleColor = Color.rgb(62, 75, 55),
        subtitleColor = Color.rgb(111, 133, 100),
        accentColor = Color.rgb(187, 209, 173),
        doneColor = Color.rgb(111, 151, 111),
        doneTextColor = Color.rgb(107, 124, 100),
    ),
    APK_PINK(
        raw = "apk_dot_f1a5b6",
        label = "粉色圆点",
        ...
        titleColor = Color.rgb(79, 51, 61),
        subtitleColor = Color.rgb(142, 99, 114),
        accentColor = Color.rgb(241, 165, 182),
        doneColor = Color.rgb(100, 164, 121),
        doneTextColor = Color.rgb(134, 108, 117),
    ),
    APK_YELLOW(
        raw = "apk_dot_f8d58a",
        label = "浅黄圆点",
        title = "手账日程",
        dotResourceName = "ic_widget_dot_f8d58a",
        backgroundColor = Color.rgb(255, 252, 244),
        titleColor = Color.rgb(79, 64, 39),
        subtitleColor = Color.rgb(139, 119, 82),
        accentColor = Color.rgb(248, 213, 138),
        doneColor = Color.rgb(116, 156, 100),
        doneTextColor = Color.rgb(130, 116, 91),
    ),
    APK_WHITE(
        raw = "apk_dot_ffffff",
        label = "白色圆点",
        ...
        subtitleColor = Color.rgb(226, 226, 226),
        accentColor = Color.rgb(255, 255, 255),
        doneColor = Color.rgb(203, 219, 191),
        doneTextColor = Color.rgb(217, 217, 217),
    );
...
class ScheduleWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        private fun buildScheduleViews(
            ...
            views.setTextViewText(R.id.widget_status_pill, if (todo.isEmpty()) "本地已解锁" else "${todo.size} todo")
            views.setTextViewText(R.id.widget_footer, "本地全解锁 · 点击打开日程手账")
